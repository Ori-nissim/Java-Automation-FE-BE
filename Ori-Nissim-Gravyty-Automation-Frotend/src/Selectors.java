...
public class Selectors {
	    ...
	    public static final String COMPANY_LIST_SELECTOR = "ul.artdeco-card__list";
	    ...
	    public static final String MY_NETWORK_BUTTON_SELECTOR = "xpath=/html/body/div[5]/header/div/nav/ul/li[2]/a";
